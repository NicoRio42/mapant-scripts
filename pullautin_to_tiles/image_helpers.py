...
def fill_small_png_with_alpha(png_path, pgw_path, tile_pixel_size, tile_meter_size, tile_geometry):
    ...
    if fill_left and fill_right:
        left_transparent_width = int(abs(png_georef_point[0] - tile_geometry[0][0]) / tile_scale)
        right_transparent_width = tile_pixel_size - image_width - left_transparent_width
        left_transparent = create_transparent_image(left_transparent_width, image_height)
        right_transparent = create_transparent_image(right_transparent_width, image_height)
    ...
    if fill_up and fill_down:
        up_transparent_height = int(abs(png_georef_point[1] - tile_geometry[0][1]) / tile_scale)
        down_transparent_height = tile_pixel_size - image_height - up_transparent_height
        up_transparent = create_transparent_image(tile_pixel_size, up_transparent_height)
        down_transparent = create_transparent_image(tile_pixel_size, down_transparent_height)
