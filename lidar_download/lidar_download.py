...
def lidar_download(ftp_adress,
    ...
    for tile in tiles['features']:
        ...
        if os.path.exists(local_filename):
            ...
            progress_message(number_of_skiped_files,
...
def progress_message(number_of_skiped_files,
    number_of_downloaded_files,
    total_number_of_files):

    print(str(number_of_skiped_files) + ' skiped files and ' + \
